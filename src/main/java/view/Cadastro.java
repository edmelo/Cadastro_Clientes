...
public class Cadastro extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Cadastro(Cliente clienteSelecionado, TelaPrincipal jPrincipal) {
		DAO dao = new DAO();
	...
	private void abrirTelaPrincipal(TelaPrincipal jPrincipal) {
		jPrincipal.dispose();
		dispose();
		jPrincipal = new TelaPrincipal();
